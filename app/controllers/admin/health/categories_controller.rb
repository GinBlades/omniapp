class Health::CategoriesController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @health_category.save
        format.html { redirect_to @health_category, notice: 'Category was successfully created.' }
        format.json { render :show, status: :created, location: @health_category }
      else
  ...
  def update
    respond_to do |format|
      if @health_category.update(health_category_params)
        format.html { redirect_to @health_category, notice: 'Category was successfully updated.' }
        format.json { render :show, status: :ok, location: @health_category }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to health_categories_url, notice: 'Category was successfully destroyed.' }
