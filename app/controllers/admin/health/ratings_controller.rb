class Health::RatingsController < AdminController
  ...
  def create
    ...
    respond_to do |format|
      if @health_rating.save
        format.html { redirect_to @health_rating, notice: 'Rating was successfully created.' }
        format.json { render :show, status: :created, location: @health_rating }
      else
  ...
  def update
    respond_to do |format|
      if @health_rating.update(health_rating_params)
        format.html { redirect_to @health_rating, notice: 'Rating was successfully updated.' }
        format.json { render :show, status: :ok, location: @health_rating }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to health_ratings_url, notice: 'Rating was successfully destroyed.' }
